/**
 * Heuristic scam-risk flagging. Looks for the most common red flags in
 * Nigerian rental scams: pressure to pay off-platform, "no inspection
 * needed" language, and unverified listings priced far below comparable
 * ones.
 */
