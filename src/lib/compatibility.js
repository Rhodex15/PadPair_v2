/**
 * Heuristic roommate compatibility scoring, used only until the real
 * backend `compatibility.service.js` (Claude API call) exists. Weighted
 * agreement across five lifestyle dimensions, each contributing to 100%.
 */
const WEIGHTS = {
  cleanliness: 25,
  sleepSchedule: 25,
